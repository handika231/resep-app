...
abstract class $LoginCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? message, @JsonKey(name: 'api_token') String? apiToken});
}
...
class _$_Login implements _Login {
  _$_Login({this.message, @JsonKey(name: 'api_token') this.apiToken});
  ...
  @override
  String toString() {
    return 'Login(message: $message, apiToken: $apiToken)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, message, apiToken);
...
abstract class _Login implements Login {
  factory _Login(
      {final String? message,
      @JsonKey(name: 'api_token') final String? apiToken}) = _$_Login;
